...
public class SeedData implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
       ...
       account02.setAge(25);
       account02.setDate_of_birth(LocalDate.parse("2021-11-01"));
       ...
       account03.setAge(50);
       account03.setDate_of_birth(LocalDate.parse("1975-09-11"));
       ...
       account04.setAge(40);
       account04.setDate_of_birth(LocalDate.parse("1986-03-06"));
